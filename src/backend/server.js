require("dotenv").config({
  path: "C:/Users/Kohei/Desktop/cs4471/GoContract/.env",
});
...
app.post("/addBooking", async (req, res) => {
  const { clientId, contractorId, date, serviceType, serviceDetails } =
    req.body;
  // Validate input
  // console.log("test1");
  // console.log(title);
  ...
  if (!clientId || !contractorId || !date || !serviceType || !serviceDetails) {
    return res.status(400).send("Title, description, and user ID are required");
  }
  console.log("test2");
